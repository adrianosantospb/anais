...
$.extend($.validator, {
	...
	messages: {
		...
		remote: "Favor corrigir este campo.",
		...
		rangelength: $.validator.format("Por favor insira um valor enter {0} e {1} caracteres."),
		range: $.validator.format("Por favor insira um valor enter {0} e {1}."),
